const pmDialogs = {
    ...
    confirm(title, message, callback) {
        ...
        document.getElementById('pm-confirm-dialog').style.display = 'flex';
    },
    closeConfirm(result) {
        document.getElementById('pm-confirm-dialog').style.display = 'none';
        if (result && this._confirmCallback) {
